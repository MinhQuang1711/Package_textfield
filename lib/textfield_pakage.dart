...
class TextfieldCustomPakage extends StatefulWidget {
  const TextfieldCustomPakage({
    super.key,
    this.obs,
    this.hintStyle,
    this.debounce,
  ...
  @override
  State<TextfieldCustomPakage> createState() => _TextfieldCustomPakageState();
}

class _TextfieldCustomPakageState extends State<TextfieldCustomPakage> {
